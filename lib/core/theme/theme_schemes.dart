...
const Map<AppThemeScheme, ThemeScheme> themeSchemes = {
  ...
  AppThemeScheme.monokai: ThemeScheme(
    name: 'Monokai',
    lightPrimary: Color(0xFF66D9EF),
    lightSecondary: Color(0xFFA6E22E),
    lightBackground: Color(0xFFF8F8F2),
    lightSurface: Color(0xFFFFFFFF),
    darkPrimary: Color(0xFF66D9EF),
  ...
  AppThemeScheme.dracula: ThemeScheme(
    name: 'Dracula',
    lightPrimary: Color(0xFFBD93F9),
    lightSecondary: Color(0xFFFF79C6),
    lightBackground: Color(0xFFF8F8F2),
    lightSurface: Color(0xFFFFFFFF),
  ...
  AppThemeScheme.gruvbox: ThemeScheme(
    name: 'Gruvbox',
    lightPrimary: Color(0xFF458588),
    lightSecondary: Color(0xFFB16286),
    lightBackground: Color(0xFFFBF1C7),
    lightSurface: Color(0xFFFFFFFF),
    darkPrimary: Color(0xFF83A598),
...
ThemeData lightThemeForScheme(ThemeScheme scheme) {
  return ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      foregroundColor: scheme.lightPrimary,
      elevation: 0,
    ),
  );
}
...
ThemeData darkThemeForScheme(ThemeScheme scheme) {
  return ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      foregroundColor: scheme.darkPrimary,
      elevation: 0,
    ),
  );
}
